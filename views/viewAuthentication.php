    ...
    <div class="container">
        ...
        <form class="form-signin" method="POST" action="authentication">
            ...
            <div class="col-lg-4 offset-lg-4 mb-3">
                <label for="emailConnexion" class="sr-only">Adresse Email</label>
                <input type="email" name="emailConnexion" id="emailConnexion" class="form-control" placeholder="Adresse Email">
            </div>
            <div class="col-lg-4 offset-lg-4 mb-3">
                <label for="passwordConnexion" class="sr-only">Mot de passe</label>
                <input type="password" name="passwordConnexion" id="passwordConnexion" class="form-control" placeholder="Mot de passe">
            </div>
